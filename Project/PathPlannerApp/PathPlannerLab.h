...
{
	AStarPathfinding::algorithms::PathSearch search_;
	AStarPathfinding::TileMap&               tile_map_;
	AStarPathfinding::Tile const*            start_tile_;
	AStarPathfinding::Tile const*            goal_tile_;
	...
	std::vector<AStarPathfinding::Tile const*> path2; 

public:
	GroundUpPathPlanner(AStarPathfinding::TileMap& tiles);
	bool isReady() const;
...
class PathPlannerLab
{
	...
	AStarPathfinding::TileMap   ground_up_tile_map_;
